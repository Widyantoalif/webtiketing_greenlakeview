...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="login/logout.php" class="get-started-btn scrollto">Logout</a>
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="carousel-container">
            <div class="container">
              ...
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Pesan tiket sekarang</a>
            </div>
          </div>
        </div>
                ...
                <div class="icon icon-calendar dark">
                  <select id="id_user" name="id_user" class="selectpicker form-control" data-live-search="true" onchange="changeValue(this.value)">
                    ...
                    while ($data = mysqli_fetch_array($sql)) {
                      ...
                      echo '<option value="' . $data['id_harga'] . '">' . $data['nama_tiket'] . '</option> ';
                    }
                    ?>
                  </select>
                </div>
