    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php
                    $sqlharga = mysqli_query($konek, "select * from booking where id_user = '$id_user' group by id_booking");
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="col-md-6 text-right">
                                            ...
                                            <a href="#" type="button" class="btn btn-warning btn-md" data-toggle="modal" data-target="#modaltransfer<?php echo $id_booking; ?>">Batalkan Pembelian</a>
                                        </div>
                                    <?php
                                    } elseif ($status == "Menunggu konfirmasi") {
                                    ?>
                                        <div class="col-md-6 text-right">
                                            <a href="#" type="button" class="btn btn-warning btn-md" data-toggle="modal" data-target="#modalkonfirmasi">Cek Tiket</a>
                                        </div>
                                    <?php
