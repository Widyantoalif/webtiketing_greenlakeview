...
<head>
  ...
  $batas = date('Y-m-d');
  mysqli_query($konek, "UPDATE booking SET status ='Telah digunakan' WHERE batas_penukaran ='$batas'");
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      ?>
        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="data_booking.php">Data Booking</a>
              <a class="collapse-item" href="data_transaksi.php">Data transaksi</a>
              <a class="collapse-item" href="data_metode.php">Data Metode Pembayaran</a>
            </div>
          </div>
        </li>
        <li class="nav-item active">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="tukar_tiket.php">
            <i class="fas fa-fw fa-barcode"></i>
            <span>Penukaran Tiket</span></a>
        </li>
      ...
      ?>
        ...
        <li class="nav-item active">
          <a class="nav-link" href="tiketku.php">
